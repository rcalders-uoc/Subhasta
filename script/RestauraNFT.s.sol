...
contract RestauraNFT is Script {
    function run() external {
        ...
        bytes memory dadesAprovacio = abi.encodeWithSignature("setApprovalForAll(address,bool)", Venedor, true);
        ...
        IERC721(contracteNFT).safeTransferFrom(Licitador, Venedor, idToken);
